...
namespace Sugar\UI\Framework\UIkit_v3_15_3;
...
class UIkit extends Component {
	...
	function ready() {
		...
		if ($this->file_base) {
            ...
            // NB: temporary fix, modified version with focusin event disabled for modals
			\Assets::instance()->addJs('dist/js/uikit.js',8,'footer','top');
