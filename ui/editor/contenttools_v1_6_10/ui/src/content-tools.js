...
(function() {
  ...
  ContentEdit.Image = (function(_super) {
    ...
    Image.prototype.src = function(imageURL,width,height,keepWidth) {

      if (keepWidth) {
        var oldWidth = parseInt(this._attributes['width']);
        var proz = oldWidth / width;
        width = Math.round(width * proz);
        height = Math.round(height * proz);
      }
      ...
      this._domElement.style.height = "" + sizes[1] + "px";
...
(function() {
  ...
  ContentTools.Style = (function() {
    function Style(name, cssClass, applicableTo, defaultOn) {
      this._name = name;
    ...
    Style.prototype.defaultOn = function() {
  ...
  ContentTools.Tool = (function() {
    ...
    Tool._insertAt = function(element) {
      ...
      insertIndex = parent.children.indexOf(insertNode) + 1;
  ...
  ContentTools.Tools.Link = (function(_super) {
    ...
    Link.getTag = function(element, selection) {
      var c, from, selectedContent, tag, to, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      if (element.type() === 'Image') {
        if (element.a) {
          return element.a;
  ...
  ContentTools.Tools.Paragraph = (function(_super) {
    ...
    Paragraph.canApply = function(element, selection) {
      if (typeof element !== 'undefined' && element.isFixed()) {
        return false;
      }
