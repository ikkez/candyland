(function() {
  ...
  ContentFlow.SnippetModel = (function() {
    ...
    SnippetModel.fromJSONType = function(flow, jsonTypeData) {
      ...
      return new ContentFlow.SnippetModel(jsonTypeData.id, snippetTypeClass.fromJSONType(flow, jsonTypeData), jsonTypeData.scope, jsonTypeData.settings, jsonTypeData.global_id, jsonTypeData.global_label);
    };
  ...
  ContentFlow.ListSnippetsUI = (function(_super) {
    ...
    function ListSnippetsUI() {
      ListSnippetsUI.__super__.constructor.call(this, ContentEdit._('Content'));
      this._tools = {
        order: new ContentFlow.InlayToolUI('order', ContentEdit._('Order'), true),
        add: new ContentFlow.InlayToolUI('add', ContentEdit._('Add'), true)
      };
  ...
  ContentFlow.MakeSnippetGlobalUI = (function(_super) {
    ...
    function MakeSnippetGlobalUI() {
      ...
      this._tools = {
        confirm: new ContentFlow.InlayToolUI('confirm', ContentEdit._('Confirm'), true),
        cancel: new ContentFlow.InlayToolUI('cancel', ContentEdit._('Cancel'), true)
      };
  ...
  ContentFlow.OrderSnippetsUI = (function(_super) {
    ...
    function OrderSnippetsUI() {
      ...
      OrderSnippetsUI.__super__.constructor.call(this, ContentEdit._('Order'));
      this._tools = {
        confirm: new ContentFlow.InlayToolUI('confirm', ContentEdit._('Confirm'), true),
        cancel: new ContentFlow.InlayToolUI('cancel', ContentEdit._('Cancel'), true)
      };
      ...
      return result.addEventListener('load', (function(_this) {
        return function(ev) {
          ...
          for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
            ...
            var uiSnippet = new ContentFlow.SnippetUI(snippet, 'order');
            _this._body.attach(uiSnippet);
            uiSnippet.addEventListener('over', function(ev) {
                return ContentFlow.highlightSnippetDOMElement(ContentFlow.FlowMgr.get().flow(), ev.detail().snippet);
            });
  ...
  ContentFlow.SnippetSettingsUI = (function(_super) {
    ...
    function SnippetSettingsUI() {
      SnippetSettingsUI.__super__.constructor.call(this, ContentEdit._('Settings'));
      this._tools = {
        confirm: new ContentFlow.InlayToolUI('confirm', ContentEdit._('Confirm'), true),
        cancel: new ContentFlow.InlayToolUI('cancel', ContentEdit._('Cancel'), true)
      };
